...
<html lang="hi">
  ...
  <body>
    ...
    <script>
      ...
      // Add Student with Photo Upload Handling
      document
        ...
        .addEventListener("submit", function (e) {
          ...
          if (photoFile) {
            ...
            reader.onloadend = function () {
              createStudentObj(reader.result);
            };
          ...
          tr.innerHTML = `
                <td>
                  <div class="student-cell">
                    <img src="${student.photo || defaultAvatar}" class="student-thumb" alt="Photo" />
                    <div>
                      <strong>${student.name}</strong><br><small>📱 ${student.mobile}</small>
                    </div>
                  </div>
                </td>

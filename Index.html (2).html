  ...
  <body>
    <div class="container">
      ...
      <div id="authScreen" class="auth-container">
        ...
        <div class="auth-tabs">
          ...
          <div id="tabStudent" class="auth-tab" onclick="switchTab('student')">
            Student Login
          </div>
        </div>
            ...
            <form id="addStudentForm">
              ...
              >
                ...
                <select id="sBelt" required>
                  ...
                  <option value="Green One Belt">Green Belt</option>
          ...
          <div class="section">
            ...
            <div class="profile-card">
              ...
              <div class="profile-grid">
                <p>
                  <strong>Mobile:</strong> <span id="stProfileMobile"></span>
                </p>
                <p>
                ...
                <p>
                  <strong>Address:</strong> <span id="stProfileAddress"></span>
                </p>
              </div>
            </div>
          </div>
    ...
    <script>
      ...
      function toggleFee(key, studentId) {
        ...
        monthlyRecords[key][studentId].feeStatus =
          cur === "Paid" ? "Pending" : "Paid";
        saveRecords();
        renderAdminData();
      }
      ...
      function deleteStudent(id) {
        if (
          confirm("Kya aap is student profile ko delete karna chahte hain?")
        ) {
